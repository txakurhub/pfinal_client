    ...
    <form onSubmit={handleSubmit} className="h-full w-full">
      ...
      {/* <div className="flex flex-row w-full justify-evenly"> */}
        ...
        <div className="flex flex-row w-[48%] m-auto my-2">
          ...
          {user&& <span className="no-underline hover:underline cursor-pointer ml-2" onClick={()=>{resetPassword(user.email); swal("Atención","Se envio un correo al usuario para restablecer la contraseña","warning")}}>Resetear</span>}
