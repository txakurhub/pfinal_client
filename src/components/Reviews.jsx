    ...
    return (
        <div className="flex flex-col items-center w-full m-auto">
            <form className="relative w-full" onSubmit={handlesubmit}>
                ...
                <button onChange={(e) => handlesubmit(e)} title="Enviar cambios" className="absolute top-2 right-2 cursor-pointer">
                ...
                <textarea value={input.comment} className="bg-gray-100 rounded border border-transparent focus:border-gray-400 leading-normal resize w-full h-20 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white" type="text" placeholder="Agregar un comentario" name="comment" id="comentario" onChange={(e) => handlechange(e)}/>
            </form>
            {
                reviews.map((r) => (
