        ...
        <div className="relative">
          ...
          <div className="dark:bg-gray-900 relative w-full bg-gray-100 shadow-sm p-6">
            <div className="container mx-auto flex items-center justify-between">
              ...
              {admin && <a href="/admin" className={`text-black-50 font-medium h-[25px] hover:text-orange-700 h-[25px] truncate cursor-pointer dark:text-white`}>Admin</a>}
                {
                  user ?
                ...
                <div className="hidden lg:flex items-center space-x-4 xl:space-x-8">
                  <button onClick={() => To('user/1/wishlist')} aria-label="view favourites" className="relative text-gray-800 dark:hover:text-gray-300 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
                    <svg className="fill-stroke" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
