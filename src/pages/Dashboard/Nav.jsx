    ...
    <div className="dark:bg-gray-900 relative w-full bg-gray-100 shadow-sm p-6">
      ...
      <div id="md-searchbar" className={`${mdOptionsToggle ? "hidden" : "flex"} bg-gray-100 dark:bg-gray-900 lg:hidden pb-5 pt-0 items-center justify-center`}>
        <ul className={`hidden md:flex items-center justify-center space-x-8 bg-white w-full py-2 rounded-xl`}>
          <li>
            <a onClick={(e) => handleClick("dashboard")} className="cursor-pointer dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
              Dashboard
            </a>
          </li>
          <li>
            <a onClick={(e) => handleClick("customers")} className="cursor-pointer dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
              Customers
            </a>
          </li>
          <li>
            <a onClick={(e) => handleClick("shoes")} className="cursor-pointer dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
              Shoes
            </a>
          </li>
          <li>
            <a onClick={(e) => handleClick("categories")} className="cursor-pointer dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
              Categories
            </a>
          </li>
          <li>
            <a onClick={(e)=>handleClick("order")} className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
              Order status
            </a>
          </li>
        </ul>
      ...
      <div className="dark:bg-gray-900 bg-gray-100 container mx-auto flex items-center justify-between">
        ...
        <div className="justify-end flex items-center space-x-4 xl:space-x-8">
          <ul className={`hidden lg:flex items-center justify-center space-x-8`}>
            ...
            <li>
              <a onClick={(e)=>handleClick("order")} className="cursor-pointer dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                Order status
              </a>
            </li>
          </ul>
