      ...
      {currentProduct&&show? (
       ...
       <button 
        onClick={() => setShow(show === false ? true : false)}
         className="hover:text-gray-500 text-gray-600 bg-gray-100 py-3.5 px-3 rounded-sm flex flex-row justify-center items-center space-x-3">
      ...
      <article className={classCol}>
      {
        ...
        <div className="bg-gray-200">
          <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
            {/* <h2 className="sr-only text-black">Productos</h2> */}
